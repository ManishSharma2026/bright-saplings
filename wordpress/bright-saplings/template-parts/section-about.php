...
<section class="section" id="about">
  <div class="wrap about">
    ...
    <div class="about__media reveal">
      <figure class="frame">
        <img class="img-real img-real--portrait" src="images/about.jpg"
             alt="A toddler turning the pages of a picture book on the play mat"
             width="950" height="1108" loading="lazy" decoding="async">
        <!-- ⟨CAPTION⟩ Same reasoning as the hero: no place claimed. -->
        <figcaption>somewhere in the middle of a story</figcaption>
      </figure>
